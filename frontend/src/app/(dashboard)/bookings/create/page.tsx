            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={form.eventType} onValueChange={(v) => update('eventType', v || '')}>
                  ...
                  <SelectContent>
                    {['Wedding', 'Pre-wedding', 'Portrait', 'Event', 'Commercial', 'Product'].map(t => (
              ...
              <div className="space-y-2">
                ...
                <Select value={form.freelancerId} onValueChange={(v) => update('freelancerId', v || '')}>
                  <SelectTrigger><SelectValue placeholder="Pilih freelancer" /></SelectTrigger>
                  <SelectContent>
                    {team.map(t => (
              ...
              <div className="space-y-2">
                ...
                <Input type="date" value={form.sessionDate} onChange={e => update('sessionDate', e.target.value)} required />
              </div>
              <div className="space-y-2">
                <Label>Jam Mulai *</Label>
                <Select value={form.sessionTime} onValueChange={(v) => update('sessionTime', v || '')}>
              ...
              <div className="space-y-2">
                <Label>DP (Rp)</Label>
                <Input type="number" value={form.dpAmount} onChange={e => update('dpAmount', Number(e.target.value))} />
              </div>
            </div>
            <div className="space-y-2">
              <Label>Catatan</Label>
